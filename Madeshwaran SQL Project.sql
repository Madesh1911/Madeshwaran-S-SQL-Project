...
UPDATE logistics_Emp SET TOTAL_PAYABLE_CHARGES = SH_CHARGES + AMOUNT;
...
#QUESTION 7
SELECT C_ID, C_NAME, START_DATE, END_DATE, ROUND(DATEDIFF(END_DATE, START_DATE)/365,0) AS Membership_Years FROM logistics_Emp HAVING Membership_Years > 10;

#QUESTION 8
SELECT * FROM logistics_Emp HAVING DATEDIFF(DELIVERY_DATE, SENT_DATE)=1;

#QUESTION 9
SELECT SH_CONTENT, SUM(AMOUNT) AS Content_Wise_Amount FROM logistics_Emp GROUP BY (SH_CONTENT) ORDER BY Content_Wise_Amount DESC LIMIT 5;
